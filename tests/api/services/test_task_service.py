...
class TestTaskService:
    ...
    def test_create_task(self, farm):
        ...
        db_task = Task.get(new_task.id)

        assert new_task is db_task

    def test_create_task_with_too_much_content(self, farm):
        """
    ...
    def test_get_tasks(self, farm, tasks):
        """
    ...
    def test_filter_complete_tasks(self, farm, tasks):
        """
    ...
    def test_filter_incomplete_tasks(self, farm, tasks):
        """
    ...
    def test_get_task_by_id(self, farm):
        """
